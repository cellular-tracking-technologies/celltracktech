#' Catch files with errors
#'
#' This function allows you to find files that have erroneous lines
#' @param outpath where your files were downloaded
#' @param dest where flawed files will go
#' @export
#' @examples
#' findfiles("~/mydata", "~/error_files")
